...
const jsonLd = {
        ...
        url: `https://bociltogelive.pages.dev/v/${file.filecode}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `WatchAction`,
                target: `https://bociltogelive.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd2 = {
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bociltogelive.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bociltogelive.pages.dev'
              },
        interactionStatistic: {
            '@type': `InteractionCounter`,
                userInteractionCount: `${file.views}`,
...
<Script src="https://js.juicyads.com/jp.php?c=947403z2v256s2w2x2f4x2c4&u=http%3A%2F%2Fwww.juicyads.rocks"/>
        ...
        {/* ... */}
            ...
            </Card><center><Script dangerouslySetInnerHTML={{__html: `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1025828})`,}}/>
<Script data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"/>
<ins id="1025828" data-width="300" data-height="262"></ins></center>
...
<center><Script dangerouslySetInnerHTML={{__html: `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1025827})`,}}/>
<Script data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"/>
<ins id="1025827" data-width="300" data-height="262"></ins></center>
            <h2 className="text-2xl font-bold text-center my-4">
                Related Video {file.title}
            </h2>
<center><Script dangerouslySetInnerHTML={{__html: `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1025826})`,}}/>
<Script data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"/>
<ins id="1025826" data-width="300" data-height="262"></ins></center>
